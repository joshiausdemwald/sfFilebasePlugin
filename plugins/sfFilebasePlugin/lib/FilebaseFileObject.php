...
class FilebaseFileObject extends splFileObject
{
  ...
  public function __call($method_name, $args)
  {
	 ...
	 *
	 * @param FilebaseFile $file_name         The name of the stream to open
   ...
   * @throw RuntimeException   If file cannot be opened (e.g. insufficient
	 *                           access rights).
	 */
	function __construct(FilebaseFile $file_name, Filebase $filebase, $open_mode = 'r', $use_include_path = false, $context = null)
	{
    is_resource($context) ?
  ...
  /**
   * Returns the underlying FilebaseInfo
   * instance.
   * 
  ...
  public function fileGetContents($flags = null, $context=null, $offset=null, $maxlen=null)
  {
    ...
    if($ret === false) throw new FilebaseException(sprintf('Error reading file %s: %s', $this->getPathname(), implode('\n', error_get_last())));
    return $ret;
  }
