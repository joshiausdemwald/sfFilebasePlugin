 ...
 */
class sfFilebaseSynchronizeTask extends sfBaseTask
{
...
The [sfFilebase:synchronize|INFO] imports files and directories into your filebase application database.
Call it with:
  [php symfony sfFilebase:synchronize|INFO]
EOF;
  }
