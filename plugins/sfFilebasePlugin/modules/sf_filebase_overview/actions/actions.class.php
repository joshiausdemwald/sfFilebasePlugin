...
class sf_filebase_overviewActions extends sfActions
{
  ...
  */
  public function executeIndex(sfWebRequest $request)
  {
    ...
    if($this->tag == '___')
    {
      $this->getUser()->setAttribute('tag', null, 'sf_filebase_overview');
      $this->tag = null;
    }
    else
    {
      if(empty($this->tag))
      {
        $this->tag = $this->getUser()->getAttribute('tag', null, 'sf_filebase_overview');
      }
      else
      {
        $this->getUser()->setAttribute('tag', $this->tag, 'sf_filebase_overview');
      }
    }
