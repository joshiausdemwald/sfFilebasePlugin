...
/**
 * PluginsfAbstractFile filter form base class.
 *
 * @package    filters
 * @subpackage PluginsfAbstractFile *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BasePluginsfAbstractFileFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pluginsf_abstract_file_filters[%s]');
