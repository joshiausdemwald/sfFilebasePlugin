...
/**
 * PluginsfAbstractFile form base class.
 *
 * @package    form
 * @subpackage pluginsf_abstract_file
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BasePluginsfAbstractFileForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'          => new sfValidatorDoctrineChoice(array('model' => 'PluginsfAbstractFile', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('pluginsf_abstract_file[%s]');
